...
function Job() {
    ...
    this.saveGcodes = async function () {        
        ...
        const g21 = require("./gcodes/gcodes_21.json");
        const g22 = require("./gcodes/gcodes_22.json");
        const g23 = require("./gcodes/gcodes_23.json");
        const g24 = require("./gcodes/gcodes_24.json");
        const g25 = require("./gcodes/gcodes_25.json");
        const g26 = require("./gcodes/gcodes_26.json");
        const g27 = require("./gcodes/gcodes_27.json");
        const g28 = require("./gcodes/gcodes_28.json");
        const g29 = require("./gcodes/gcodes_29.json");
        const g30 = require("./gcodes/gcodes_30.json");
        const g31 = require("./gcodes/gcodes_31.json");
        const g32 = require("./gcodes/gcodes_32.json");
        const g33 = require("./gcodes/gcodes_33.json");
        const g34 = require("./gcodes/gcodes_34.json");
        const g35 = require("./gcodes/gcodes_35.json");
        const g36 = require("./gcodes/gcodes_36.json");
        const g37 = require("./gcodes/gcodes_37.json");
        const g38 = require("./gcodes/gcodes_38.json");
        const g39 = require("./gcodes/gcodes_39.json");
        const g40 = require("./gcodes/gcodes_40.json");
